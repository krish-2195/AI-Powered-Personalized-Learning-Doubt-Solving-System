    ...
    return (
      <div className="space-y-6">
        <h1 className="text-3xl font-bold text-slate-100 flex items-center gap-3">
          <TrendingUp className="text-primary-400" size={32} /> Performance Analytics
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[1,2,3,4].map(i => (
            <div key={i} className="card bg-white/10 border-white/10 h-24 animate-pulse rounded-xl" />
          ))}
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="card bg-white/10 border-white/10 h-80 animate-pulse rounded-xl" />
          <div className="card bg-white/10 border-white/10 h-80 animate-pulse rounded-xl" />
        </div>
      </div>
    )
    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="card bg-white/10 border-white/10 text-slate-100 p-4">
          ...
          <div className="card bg-white/10 border-white/10 text-slate-100 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{stats.time_spent_hours}</p>
              </div>
            </div>
          </div>
          <div className="card bg-white/10 border-white/10 text-slate-100 p-4">
      ...
      {!hasQuizData ? (
        <div className="card bg-white/10 border-white/10 text-slate-100 text-center py-16">
